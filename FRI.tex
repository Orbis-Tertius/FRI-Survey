...
\date{%
\today\footnote{%
This updated version of the summary clarifies the usage of the Guruswami-Sudan list size bound over the rational function field  in the proof of Theorem \ref{thm:DEEPsoundness}.
}
}
\maketitle
