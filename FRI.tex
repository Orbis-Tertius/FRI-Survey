...
\author{%
Ulrich Hab{\"o}ck\thanks{This work is supported by Horizenlabs Italia and Orbis Labs.}
\\\\
Orbis Labs
\\
...
In particular, we illustrate the DEEP method applied to proving satisifiability of algebraic intermediate representations and prove a soundness error bound which slightly improves  the one in \cite{ethSTARK}.
\end{abstract}
