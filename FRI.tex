...
The following examples consider a situation is similar to the one in plonky2 \cite{PolygonZero}. 
...
\begin{itemize}
\item
With a degree $2$ extension of $F_b$, hence a field size of $128$ bits, the best security level one can obtain for $\rho=2^{-5}$ is about $74$ bits. 
...
$-\log_2(\rho)$ & $m$	& $s$	& $T$ in hashes 	& $|\pi|$ in bytes
\\\hline\hline
$6$ 	& $1,487$	& $23$	& $209$ k 	& $89.1$ k
\\
$8$ & $743$	& $17$	& $836$ k & $68.4$ k
\\
$10$ & $371$	& $14$	& $3,342$ k 	& $58.4$ k
\\\hline
\end{tabular}
\end{center}
